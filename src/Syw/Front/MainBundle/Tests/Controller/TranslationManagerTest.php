...
class TranslationManagerTest extends BaseControllerTest
{
    ...
    {
        $trans = $this->_em->getRepository('SywFrontMainBundle:Translation')->findAll();
    ...
    {
        $trans = $this->_em->getRepository('SywFrontMainBundle:Translation')->findAll(array('messageDomain' => 'messages'));
