 ...
 * TimelineLikes
 *
 * @ORM\Table(name="timeline_likes", indexes={@ORM\Index(name="p_key", columns={"p_key"}), @ORM\Index(name="f_key_p_key", columns={"f_key", "p_key"}), @ORM\Index(name="f_key", columns={"f_key"})})
 * @ORM\Entity
 */
class TimelineLikes
{
